...
class on_member_join(commands.Cog):
    ...
    async def join_log(self, member: discord.Member):
        try:
            ...
            embed = discord.Embed(
                title="ðŸŒ¸ WELCOME TO ZYLO",
                description=(
                    f"A warm welcome to {member.mention}! âœ¨\n\n"
                    "We're happy to have you with us.\n"
                    "Enjoy the vibes, connect with everyone,\n"
                    "and make some unforgettable moments. ðŸ’™\n\n"
                    "ðŸŒ™ Stay active â€¢ Stay respectful â€¢ Have fun\n\n"
            ...
            embed.set_footer(text="Zylo Community â€¢ Welcome aboard âœ¨")
